  ...
  return (
    ...
    transition={{delay: 0.7, duration: 0.5}} 
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I specialize in developing high-quality web applications using modern technologies.
        My goal is to deliver smooth, scalable, and user-centric digital experiences.
      </motion.p>
